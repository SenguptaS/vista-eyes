...
public class StereoRenderingRenderer implements GLSurfaceView.Renderer
{
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config)
    {
        ...
        mTextRenderer = new GLText(mActivity.getAssets());
        mTextRenderer.load("Roboto-Regular.ttf", 16, 4, 4);
    ...
    private void renderFrame()
    {
        ...
        mTextRenderer.begin(0.0f, 1.0f, 0.0f, 1.0f, vuforiaAppSession.getProjectionMatrix().getData());
        mTextRenderer.draw("Co-Ordinates of Trackable", 0, 0);
        mTextRenderer.end();
